/*
trainer_control by ShinyDragonHunter (Nicknames by Spikecation)
    .nickname = COMPOUND_STRING("Nickname")
    .iv OR .iv Use .iv to assign all IVs to the same number. .ivs needs an array of six stats, in order of HP ATK DEF SPEED SPATK SPDEF; many optimal IV spreads are pre-defined in include/constants/pokemon.h
    .heldItem and .moves[MAX_MON_MOVES] are as in vanilla.
    .abilityNum should be set to 0, for first or 1, for second ability
    .ev again uses the stat order. The constants provided are not player-legal.
    .pokeball will still allow trainer-class balls to function when unset.
    .isShiny = TRUE if you want shinies :)
    TRAINER_PARTY_IVS/TRAINER_PARTY_NATURES/TRAINER_PARTY_EVS to be used before the said 
    like         .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .nature works the same way with TRAINER_PARTY_NATURE(NATURE_MODEST)
    Return and Frustastion should always have max power
*/
// Mt Chimney Hiker
...
static const struct TrainerMon sParty_Rose5[] = {
    ...
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(202, 202, 0, 0, 0, 100),
...
static const struct TrainerMon sParty_Valerie5[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(152, 0, 126, 0, 102, 126),
    ...
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(252, 100, 0, 0, 152, 0),
...
static const struct TrainerMon sParty_Dalton5[] = {
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(252, 0, 150, 0, 100, 0),
...
static const struct TrainerMon sParty_Bernie5[] = {
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(152, 252, 0, 100, 0, 0),
...
static const struct TrainerMon sParty_Jacki5[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(152, 0, 100, 0, 252, 0),
    ...
    .heldItem = ITEM_LUM_BERRY,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(100, 0, 152, 0, 252, 0),
...
static const struct TrainerMon sParty_Lao5[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(252, 152, 0, 0, 0, 100),
...
static const struct TrainerMon sParty_James5[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(126, 0, 0, 252, 126, 0),
...
static const struct TrainerMon sParty_Trent5[] = {
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(100, 252, 152, 0, 0, 0),
...
static const struct TrainerMon sParty_Andres5[] = {
    ...
    .heldItem = ITEM_SALAC_BERRY,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(150, 152, 0, 0, 0, 202),
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(252, 100, 0, 0, 100, 52),
...
static const struct TrainerMon sParty_Craig[] = {
    {
    .nickname = COMPOUND_STRING("MEGANIUM"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .species = SPECIES_MEGANIUM,
    .heldItem = ITEM_AGUAV_BERRY,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(252, 0, 132, 0, 72, 52),
    .moves = {MOVE_GRASS_WHISTLE, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_REFLECT}
    },
    {
    .nickname = COMPOUND_STRING("AERODACTYL"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_CHOICE_BAND,
    ...
    {
    .nickname = COMPOUND_STRING("MILOTIC"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_LEFTOVERS,
    ...
    {
    .nickname = COMPOUND_STRING("RAYQUAZA"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    .heldItem = ITEM_MAGNET,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(76, 0, 0, 252, 180, 0),
    ...
    .heldItem = ITEM_WHITE_HERB,
    .abilityNum = 0,
    .ev = TRAINER_PARTY_EVS(252, 0, 12, 152, 32, 60),
...
static const struct TrainerMon sParty_Weebra[] = {
    {
    .nickname = COMPOUND_STRING("JIRACHI"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    {
    .nickname = COMPOUND_STRING("LUDICOLO"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_LEFTOVERS,
    ...
    {
    .nickname = COMPOUND_STRING("GENGAR"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_BRIGHT_POWDER,
    ...
    {
    .nickname = COMPOUND_STRING("METAGROSS"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .species = SPECIES_METAGROSS,
    .heldItem = ITEM_SCOPE_LENS,
    ...
    {
    .nickname = COMPOUND_STRING("LATIOS"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    {
    .nickname = COMPOUND_STRING("CINDERELLA"),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .species = SPECIES_HITMONTOP,
    .heldItem = ITEM_KINGS_ROCK,
